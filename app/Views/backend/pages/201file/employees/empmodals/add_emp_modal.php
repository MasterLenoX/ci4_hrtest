<div class="modal fade bs-example-modal-lg" id="employee-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: none;" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <form class="modal-content" action="<?= route_to('add-employee') ?>" method="post" id="add_employee_form">
